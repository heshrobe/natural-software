...
(define-design-editor-command (com-kill-all-implementatons :name t)
    ((existing-design 'design))
  (Kill-all-implementations existing-design))

(defun kill-all-implementations (design)
  (loop for implementation in (implementations design)
      do (loop for component in (children design)
	     do (kill-all-implementations component))
	 (remove-design clim:*application-frame* design)))
